...
- [ ] **DOI-CLASS-05**: L10.81 (paraneoplastic pemphigus) encounters carry a `paraneoplastic_flag` so cancer-associated pemphigus is distinguishable from primary autoimmune pemphigus
