...
- [x] **DBING-03**: User can see PATID indexes on all 13 tables and ENCOUNTERID indexes on 8 tables, with round-trip dimension/column verification passing for all tables
