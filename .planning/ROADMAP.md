...
Plans:
- [ ] 124-01-PLAN.md — R/26 + get_chemo_hits source_hints provenance + canonical raw-name fallback (D-06/D-07/D-10-reg/D-12)
- [ ] 124-02-PLAN.md — R/28 source_table/code_type override from source_hints + R/20 MED_ADMIN code_type fix (D-04/D-05)
