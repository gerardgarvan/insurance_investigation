...
**Current focus:** Enrich Gantt export data with per-code treatment line labels, medication names, code metadata, and cross-use flags from all_codes_resolved2.xlsx, while fixing false-positive SCT codes.
...
**Status:** Not started
**Current Plan:** None
**Last activity:** 2026-06-07 — Roadmap created for v2.3
