...
**Shipped:** v3.1 (2026-06-12). 105 phases completed across 16 milestones (v1.0-v3.2). Phase 105 complete — code classification verification (Ethna/etanercept, organ transplant 0362, SCT diagnosis codes) and HL+NHL dual-code overlap validation. Phase 104 — pre-diagnosis treatment flagging and secondary malignancy table. Phase 103 — death date cross-tab summary. Phase 102 — co-administration analysis. Phase 101 — broadened drug grouping.
...
---
*Last updated: 2026-06-15 — Phase 105 complete (code classification verification + HL+NHL overlap validation)*
