...
- **Numbered pipeline scripts:**
  ...
  - Ad-hoc (90-99): 10
  - **Total numbered:** 69
- **Post-renumber investigations (100+):** 10 (R/100 RUCA, R/101 Gantt lifespan, R/102 death-cause NHL flag, R/103 death-cause diagnostic, R/104 Gantt entire-history, R/105 Supportive Care Normalized Meaning, R/106 ZIP change frequency, R/107 MED_ADMIN/DISPENSING chemo-gap sizing, R/108 NDC->RxNorm crosswalk builder, R/109 MED_ADMIN/DISPENSING fix before/after diff + unmatched-NDC audit)
