...
md <- c(md,
  ...
  "",
  "**AMC lookup table:**",
  glue("- {length(AMC_PAYER_LOOKUP)} codes mapped to 8 categories from payer_primary_codes_frequency_AMC.xlsx"),
  "",
  "### Patient-Level Payer Summary Variables",
  "",
  "| Variable | Description |",
  "|----------|-------------|",
  "| PAYER_CATEGORY_PRIMARY | Mode of AMC 8-category payer across all encounters for the patient |",
